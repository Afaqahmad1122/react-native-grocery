  ...
  return (
    ...
    >
      ...
      <View className="px-6 pt-4">
        <Text className="text-center text-5xl font-bold tracking-tight text-primary-foreground uppercase font-mono dark:text-foreground">
          Grocify
        </Text>
      ...
      <View className="mt-8 flex-1 rounded-t-[36px] bg-card px-6 pb-8 pt-6">
        ...
        <View className="mt-6">
          ...
          >
            <View className="h-8 w-8 items-center justify-center rounded-full bg-white">
              <FontAwesome name="github" size={20} color="#5f6e66" />
            </View>
          ...
          <Pressable
            className={`h-14 flex-row items-center rounded-2xl border border-border bg-card px-4 active:opacity-90 ${
              isLoading ? "opacity-70" : ""
            }`}
            disabled={isLoading}
          ...
          >
            <View className="h-8 w-8 items-center justify-center rounded-full bg-white">
              <FontAwesome name="apple" size={20} color="#5f6e66" />
            </View>
